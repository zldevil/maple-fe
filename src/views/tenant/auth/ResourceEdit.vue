        ...
        <el-row :gutter="35">
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item class="w100" prop="type" label="类型" required>
              ...
              >
                <el-option
                  v-for="item in ResourceTypeEnum"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                >
          ...
          >
            <el-form-item class="w100">
              <template #label>
                ...
                <el-tooltip
                  effect="dark"
                  content="与vue的组件名一致才可使组件缓存生效，如ResourceList"
                  placement="top"
                >
                  <el-icon>
                    <question-filled />
          ...
          >
            <el-form-item class="w100" prop="code">
              <template #label>
                ...
                <el-tooltip
                  effect="dark"
                  content="访问的组件路径，如：`system/resource/ResourceList`，默认在`views`目录下"
                  placement="top"
                >
                  <el-icon>
                    <question-filled />
          ...
          >
            <el-form-item class="w100">
              <template #label>
                ...
                <el-tooltip
                  effect="dark"
                  content="选择隐藏则路由将不会出现在菜单栏中，但仍然可以访问。禁用则不可访问与操作"
                  placement="top"
                >
                  <el-icon>
                    <question-filled />
          ...
          >
            <el-form-item class="w100" prop="linkType">
              ...
              <el-select
                class="w100"
                @change="changeIsIframe"
                v-model="form.meta.linkType"
                placeholder="请选择"
              >
          ...
          >
            <el-form-item prop="code" label="链接地址" class="w100">
              <el-input
                v-model.trim="form.meta.link"
                placeholder="外链/内嵌的链接地址（http://xxx.com）"
              ></el-input>
            </el-form-item>
          </el-col>
        </el-row>
...
import { resourceApi } from '@/common/sysApi'
import { ResourceTypeEnum } from '@/common/enums'
