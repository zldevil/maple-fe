<template>
  <div class="menu">
    <div class="toolbar">
      ...
      <el-button v-auth="perms.addResource" type="primary" icon="plus" @click="addResource(false)"
        >添加</el-button
      >
    </div>
    <el-tree
    ...
    <el-dialog v-model="infoDialog.visible">
      <el-descriptions title="资源信息" :column="2" border>
        ...
        <el-descriptions-item label="code[菜单path]">{{
        ...
        <el-descriptions-item
          v-if="infoDialog.data.type == menuTypeValue && infoDialog.data.meta.linkType > 0"
          label="外链"
        >
