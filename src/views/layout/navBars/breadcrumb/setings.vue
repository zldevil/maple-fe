      ...
      <el-scrollbar class="layout-breadcrumb-seting-bar">
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
              v-model="themeConfig.terminalForeground"
              size="small"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
              v-model="themeConfig.terminalBackground"
              size="small"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
              v-model="themeConfig.terminalCursor"
              size="small"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
              @change="setLocalThemeConfig"
              v-model="themeConfig.terminalFontWeight"
              size="small"
              style="width: 90px"
            >
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
              @change="setLocalThemeConfig"
              v-model="themeConfig.editorTheme"
              size="small"
              style="width: 130px"
            >
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
              v-model="themeConfig.columnsMenuBar"
              size="small"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
              v-model="themeConfig.columnsMenuBarColor"
              size="small"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt10">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="themeConfig.isTopBarColorGradual"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt14">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="themeConfig.isMenuBarColorGradual"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt14">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="themeConfig.isColumnsMenuBarColorGradual"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt14">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="themeConfig.isMenuBarColorHighlight"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="themeConfig.isUniqueOpened"
              @change="setLocalThemeConfig"
            ></el-switch>
          </div>
        </div>
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="themeConfig.isFixedHeader"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="themeConfig.isBreadcrumbIcon"
              @change="setLocalThemeConfig"
            ></el-switch>
          </div>
        </div>
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="themeConfig.isTagsviewIcon"
              @change="setLocalThemeConfig"
            ></el-switch>
          </div>
        </div>
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="themeConfig.isCacheTagsView"
              @change="setLocalThemeConfig"
            ></el-switch>
          </div>
        </div>
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="themeConfig.isSortableTagsView"
        ...
        <div class="copy-config">
          <el-alert
            title="点击下方按钮，复制布局配置去 /src/store/modules/themeConfig.ts中修改"
            type="warning"
            :closable="false"
          >
          </el-alert>
...
const onTopBarGradualChange = () => {
  setGraduaFun(
    ...
    themeConfig.value.isTopBarColorGradual,
...
const onMenuBarGradualChange = () => {
  setGraduaFun(
    ...
    themeConfig.value.isMenuBarColorGradual,
