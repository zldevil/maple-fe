        ...
        <el-tabs v-model="tabActiveName">
          <el-tab-pane label="基础信息" name="basic">
            ...
            <el-form-item prop="database" label="数据库名:" required>
              ...
              <el-col :span="4">
                <el-link @click="getAllDatabase" :underline="false" type="success"
                  >获取库名</el-link
                >
              </el-col>
            </el-form-item>
          ...
          <el-tab-pane label="其他配置" name="other">
            <el-form-item prop="params" label="连接参数:">
              <el-input
                ...
                placeholder="其他连接参数，形如: key1=value1&key2=value2"
              >
                <template #suffix>
                  <el-link
                    target="_blank"
...
const { dialogVisible, tabActiveName, allDatabases, databaseList, form, pwd, btnLoading } =
  toRefs(state)
